...
public class PermissionServiceTests
{
    ...
    private static int SeedRole(TzhjDbContext db, string name, params (FlowType Flow, string Group)[] grants)
    {
        var role = new Role
        {
            Name = name,
    ...
    private static void Assign(TzhjDbContext db, string empId, params int[] roleIds)
    {
